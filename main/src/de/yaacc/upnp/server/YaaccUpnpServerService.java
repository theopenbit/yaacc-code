...
public class YaaccUpnpServerService extends Service {
	...
	private Icon[] createDeviceIcons() {
		...
		icons.add(new Icon("image/jpeg", 120, 120, 24, URI.create("yaacc120.jpg"), getIconAsByteArray(R.drawable.yaacc120_jpg)));
		icons.add(new Icon("image/jpeg", 48, 48, 24, URI.create("yaacc48.jpg"), getIconAsByteArray(R.drawable.yaacc48_jpg)));
		icons.add(new Icon("image/jpeg", 32, 32, 24, URI.create("yaacc32.jpg"), getIconAsByteArray(R.drawable.yaacc32_jpg)));
		icons.add(new Icon("image/bmp", 120, 120, 24, URI.create("yaacc120_24.bmp"), getIconAsByteArray(R.drawable.yaacc120_24_bmp)));
		icons.add(new Icon("image/png", 120, 120, 24, URI.create("yaacc120_24.png"), getIconAsByteArray(R.drawable.yaacc120_24_png)));
		icons.add(new Icon("image/bmp", 120, 120, 8, URI.create("yaacc120_8.bmp"), getIconAsByteArray(R.drawable.yaacc120_8_bmp)));
		icons.add(new Icon("image/png", 120, 120, 8, URI.create("yaacc120_8.png"), getIconAsByteArray(R.drawable.yaacc120_8_png)));
		icons.add(new Icon("image/png", 48, 48, 24, URI.create("yaacc48_24.bmp"), getIconAsByteArray(R.drawable.yaacc48_24_bmp)));
		icons.add(new Icon("image/png", 48, 48, 24, URI.create("yaacc48_24.png"), getIconAsByteArray(R.drawable.yaacc48_24_png)));
		icons.add(new Icon("image/bmp", 48, 48, 8, URI.create("yaacc48_8.bmp"), getIconAsByteArray(R.drawable.yaacc48_8_bmp)));
		icons.add(new Icon("image/png", 48, 48, 8, URI.create("yaacc48_8.png"), getIconAsByteArray(R.drawable.yaacc48_8_png)));
		icons.add(new Icon("image/bmp", 32, 32, 24, URI.create("yaacc32_24.bmp"), getIconAsByteArray(R.drawable.yaacc32_24_bmp)));
		icons.add(new Icon("image/png", 32, 32, 24, URI.create("yaacc32_24.png"), getIconAsByteArray(R.drawable.yaacc32_24_png)));
		icons.add(new Icon("image/bmp", 32, 32, 8, URI.create("yaacc32_8.bmp"), getIconAsByteArray(R.drawable.yaacc32_8_bmp)));
		icons.add(new Icon("image/png", 32, 32, 8, URI.create("yaacc32_8.png"), getIconAsByteArray(R.drawable.yaacc32_8_png)));
